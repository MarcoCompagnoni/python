...
def analytics(conf_analytics):
    ...
    for i in range(0, number_of_rows):
        ...
        if tipo_calcolo == "trend":
            ...
            media_mobile(datasource, time_win, calcolo, progressivo)
...
def media_mobile(dataframe, time_win, tipo_media_mobile, progressivo):
        ...
        for apparecchiatura in apparecchiature:
            ...
            for strumento in strumenti:
                ...
                if tipo_media_mobile == "sma":
                    ...
                    dataframe_strumento = weighted_moving_average(dataframe_strumento, time_win)
...
def weighted_moving_average(dataframe_strumento, time_win):
